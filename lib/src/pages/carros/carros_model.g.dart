...
mixin _$CarrosModel on CarrosModelBase, Store {
  ...
  final _$loadingCarrosAsyncAction = AsyncAction('loadingCarros');

  @override
  Future loadingCarros(String tipo) {
    return _$loadingCarrosAsyncAction.run(() => super.loadingCarros(tipo));
  }
}
